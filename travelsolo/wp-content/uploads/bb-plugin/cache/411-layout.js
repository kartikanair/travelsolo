...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);function initMap(map,position,zoom){map.setCenter(position);map.setZoom(zoom);var marker=new google.maps.Marker({position:position,map:map});}var position={lat:7.873053999999999,lng:80.77179699999999};initMap(new google.maps.Map(document.getElementById('map-module-57f67c3a41c7f'),{scrollwheel:false}),position,8);