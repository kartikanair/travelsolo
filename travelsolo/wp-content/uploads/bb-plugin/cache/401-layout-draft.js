...
var wpAjaxUrl='http://localhost/travelsolo/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/travelsolo/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://localhost/travelsolo/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://localhost/travelsolo/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);function initMap(map,position,zoom){map.setCenter(position);map.setZoom(zoom);var marker=new google.maps.Marker({position:position,map:map});}var position={lat:25.2048493,lng:55.270782800000006};initMap(new google.maps.Map(document.getElementById('map-module-57f7620e5762c'),{scrollwheel:false}),position,8);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();