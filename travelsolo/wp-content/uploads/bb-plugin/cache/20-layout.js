...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);function initMap(map,position,zoom){map.setCenter(position);map.setZoom(zoom);var marker=new google.maps.Marker({position:position,map:map});}var position={lat:37.09024,lng:-95.71289100000001};initMap(new google.maps.Map(document.getElementById('map-module-5804ec2ae7101'),{scrollwheel:false}),position,8);