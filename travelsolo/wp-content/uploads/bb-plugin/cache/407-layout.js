...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);function initMap(map,position,zoom){map.setCenter(position);map.setZoom(zoom);var marker=new google.maps.Marker({position:position,map:map});}var position={lat:28.7040592,lng:77.10249019999992};initMap(new google.maps.Map(document.getElementById('map-module-57f75275b7921'),{scrollwheel:false}),position,8);